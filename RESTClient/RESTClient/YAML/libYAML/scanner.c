...
// PWMod-Start: Starting with Clang 1.6, compiling the following code results in several "Expression result unused" warnings
// To avoid the effort of fixing them within the complicated macros, we decided to turn off the warning completely.
