...
- (NSManagedObjectContext *)managedObjectContext
{
    ...
    NSLog(@"Creating managedObjectContext");
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"ConferenceModel" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSLog(@"Creating persistentStorageCoordinator");
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Conference.sqlite"];
